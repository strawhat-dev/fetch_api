...
/** Retreive a value's type from its prototype. */
...
/** Looser `JSON.stringify` allowing for Maps and Sets instead of outputting empty objects */
...
declare interface Requested extends RequestInit { input: FetchInput; }
...
declare type Narrow<T> = T extends string ? string :
...
declare type IsLiteral<T> = string extends T ? false :
